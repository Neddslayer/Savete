...
public class EntityRegistrar {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<HeliosEntity>> HELIOS = ENTITIES.register("helios", () -> EntityType.Builder.of(HeliosEntity::new, MobCategory.MISC).build("helios"));
    public static final DeferredHolder<EntityType<?>, EntityType<TantrumEntity>> TANTRUM = ENTITIES.register("tantrum", () -> EntityType.Builder.of(TantrumEntity::new, MobCategory.MISC).build("tantrum"));
    public static final DeferredHolder<EntityType<?>, EntityType<HaloEntity>> HALO = ENTITIES.register("halo", () -> EntityType.Builder.of(HaloEntity::new, MobCategory.MISC).build("halo"));
